...
namespace Kodvian.Core.Infrastructure.Migrations
{
    ...
    [Migration("20260421150937_DeveloperContractsAndReceipts")]
    partial class DeveloperContractsAndReceipts
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Kodvian.Core.Domain.Entities.DocumentFile", b =>
                {
                    ...
                    b.ToTable("DocumentFiles", null, t =>
                        {
                            t.HasCheckConstraint("CK_DocumentFiles_Owner", "(\"FinancialMovementId\" IS NOT NULL AND \"DeveloperPaymentId\" IS NULL) OR (\"FinancialMovementId\" IS NULL AND \"DeveloperPaymentId\" IS NOT NULL)");
                        });
                });
